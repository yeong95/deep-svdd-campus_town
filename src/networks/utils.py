...
class Conv2dStaticSamePadding(nn.Conv2d):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, image_size=None, bias=False, **kwargs):
        super().__init__(in_channels, out_channels, kernel_size, stride, bias, **kwargs)
        self.stride = self.stride if len(self.stride) == 2 else [self.stride[0]] * 2
...
class TransposedConv2dStaticSamePadding(nn.ConvTranspose2d):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, image_size, stride=1, output_padding=0, groups=1, bias=False, dilation=1):
